...
/* Changes in the original code by RodRivas
/*
 * The ballistic demo.
 *
...
class BallisticDemo : public Application
{
    ...
    struct AmmoRound
    {
        ...
        void render()
        {
			...
			/**Normal e/ou Magnitude */
			/** normal.normalise(); */
						
			/**Interação com o eixo y */
            ...
            glPopMatrix();
			 ...
			 glColor3f(0.0f, 0.0f, 0.0f);
						/*Linha ligando a origem com o posição atual */
			 glBegin(GL_LINES);
			{
...
void BallisticDemo::update()
{
    ...
    for (AmmoRound *shot = ammo; shot < ammo+ammoRounds; shot++)
    {
        if (shot->type != UNUSED)
        {
            ...
            if (shot->particle.getPosition().y < -5.0f ||
                shot->startTime+5000 < TimingData::get().lastFrameTimestamp ||
                shot->particle.getPosition().z > 1000.0f)
...
void BallisticDemo::display()
{
	...
	// Lesson06.cpp / Criação de um cubo com textura e que gira.
